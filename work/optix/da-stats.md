...
[DriveCam - Statistics](https://qa.velocity.optixonline.co.za/pages/drivecam/da-stats)

### Drive Alert Stats

`https://reports.optixonline.co.za/api/`
...
PROC - `**_STATS_EarlyWarningFigures_**`

---
mode: agent
description: Convert an existing React project into an npm-workspaces monorepo supporting Web (Vite) and Mobile (Ionic + Capacitor) targets with a shared UI package.
---

Act as a Senior Full-Stack Engineer and Architect. Convert my existing React/Tailwind project into a Monorepo using npm workspaces.
